...
const COLORS = [
  'rgba(23,98,255,0.95)', 'rgba(191,255,0,0.95)', 'rgba(237,108,121,0.95)',
  'rgba(167,167,167,0.95)', 'rgba(191,255,0,0.95)', 'rgba(143,161,203,0.95)',
  'rgba(221,227,240,0.95)', 'rgba(113,173,255,0.95)',
];

const FILLS = [
  'rgba(23,98,255,0.08)', 'rgba(191,255,0,0.07)', 'rgba(237,108,121,0.07)',
  'rgba(167,167,167,0.07)', 'rgba(191,255,0,0.07)', 'rgba(143,161,203,0.07)',
  'rgba(221,227,240,0.07)', 'rgba(113,173,255,0.07)',
];
